...
//#############################################################################
// FILE:   HW3CJS_Ex4_main.c
//
// TITLE:  HW3 Code for Exercise 5
//#############################################################################
...
void setupSpib(void)
{
    ...
    // Also don’t forget to cut and paste the GPIO settings for GPIO9, 63, 64, 65, 66 which are also a part of the SPIB setup.
    //-----------------------------------------------------------------------------------------------------------------

    //-----------------------------GPIO MUX Setup for SPI B-------------------------------
    ...
    EDIS;
    //-----------------------------ENDOF GPIO MUX Setup for SPI B-------------------------------


    //-----------------------------SPI B Register Setup-------------------------------
    ...
    SpibRegs.SPIBRR.bit.SPI_BIT_RATE = 49; // Set SCLK bit rate to 1 MHz so 1us period. SPI base clock is
        // 50MHZ. And this setting divides that base clock to create SCLKs period. Assuming 50MHz Clock / 1 MHz = 50. CJS
...
//    SpibRegs.SPITXBUF = (0x29 | 0x0A);
    ...
    GpioDataRegs.GPCCLEAR.bit.GPIO66 = 1;     // Write to address 0x2A the value 0x81
